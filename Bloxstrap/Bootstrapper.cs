...
namespace LumenRX
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"LumenRX-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "LumenRX-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Lumen RX instance running, aborting update check");
                return false;
            }
            ...
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "LumenRX.exe");
